...
DEFINE ('DB_USER', 'cs319_1_fall2018_group5_db');
...
///////////////////
	function getAllCheckedOutBooks($conn){
		$query = "SELECT b.book_isbn, b.book_title, b.book_author, c.date_check_out, c.date_due FROM books b INNER JOIN checked_out_books c ON b.book_isbn = c.book_isbn
		";
